...
class _WebQuoteViewState extends State<_WebQuoteView> with _QuoteStateMixin {
  ...
  void _resetForm() {
    ...
    super._resetForm();
    // Trigger rebuild on web to show cleared form
    setState(() {});
  }
                ...
                .map(
                  (p) => SizedBox(
                    ...
                    child: _PrinterCard(
                      ...
                      onTap: () => setState(() {
                        selectedPrinter = selectedPrinter?.id == p.id
                            ? null
                            : p;
  ...
  Widget _buildCategorySelector() {
    final err = QuoteController.instance.catalogError;
    final loading = QuoteController.instance.isLoadingCatalog;
    return _SectionCard(
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          _SectionTitle(
            ...
            subtitle: 'Filter materials by type',
          ),
          ...
          if (loading && materials.isEmpty)
            ...
            Padding(
              padding: const EdgeInsets.all(12),
              child: Text(
                'Could not load materials: $err',
                style: const TextStyle(fontSize: 12, color: Color(0xFFE53935)),
              ),
            )
          else if (materialCategories.isEmpty)
            Padding(
              padding: const EdgeInsets.all(12),
              child: Text(
                'No materials found. Add documents to the MATERIALS collection (name, category, price or costPerHour, quantity or avail).',
                style: TextStyle(
                  fontSize: 12,
                  ...
                  ...materialCategories.map(
                    (info) => Padding(
                      ...
                      child: _CategoryChip(
                        ...
                        onTap: () =>
                            setState(() => selectedCategoryKey = info.key),
                      ),
                    ),
                  ),
                ],
            ...
            children: [
              Expanded(
                child: _SectionTitle(
                  ...
                  subtitle: selectedCategoryKey == null
                      ? 'Showing all ${filtered.length} materials'
                      : '${filtered.length} materials in this category',
                ),
              ),
              if (selectedCategoryKey != null && materialCategories.isNotEmpty)
                Builder(
                  builder: (context) {
                    final catInfo = materialCategories.firstWhereOrNull(
                    ...
                    return catInfo != null
                        ? Container(
                            ...
                            decoration: BoxDecoration(
                              color: _QuoteStateMixin.categoryColor(
                                catInfo.category,
                              ).withOpacity(0.1),
                  ...
                  children: filtered
                      .map(
                        (m) => SizedBox(
                          ...
                          child: _MaterialCard(
                            material: m,
                            categoryColor: _QuoteStateMixin.categoryColor(
                              m.category,
                            ),
                            categoryIcon: _QuoteStateMixin.categoryIcon(
                              m.category,
                            ),
            ...
            child: currentItem == null
                ...
                : Column(
                    ...
                    children: [
                      ...
                      if (currentItem!.material.category ==
                        ...
                        if (currentItem!.material.surfaceFinishes != null) ...[
                          ...
                          Wrap(
                            spacing: 8,
                            runSpacing: 6,
                            children: currentItem!.material.surfaceFinishes!
                                .map((f) {
                        ...
                        if (currentItem!.material.tolerances != null) ...[
                          ...
                          Wrap(
                            spacing: 8,
                            runSpacing: 6,
                            children: currentItem!.material.tolerances!.map((
                              t,
                            ) {
                      ...
                      if (currentItem!.material.category ==
                        ...
                        Wrap(
                          spacing: 8,
                          runSpacing: 6,
                          children: currentItem!.material.layerOptions!.map((
                            l,
                          ) {
      ...
      children: [
        ...
        ...[
          (
            ...
            desc: 'Upload your 3D model (.stl, .obj, .3mf, .zip)',
          ...
          (
            ...
            desc: 'Pick a material and configure your print.',
          ...
          (
            icon: Iconsax.send_2,
            title: 'Submit & Print',
            desc: 'Review your quote, apply discounts, and submit.',
  ...
  Widget _buildDiscountSection() {
    return Column(
      ...
      children: [
        ...
        const SizedBox(height: 10),
        Text(
          'Select your discount category (10% off)',
